...
const IMAGE_BLOCKLIST = [
    ...
    // ── Generic placeholder cards & live-blog graphics ──
    'breaking-news-live', 'live-blog', 'editors-picks', 'share-default', 'default-share',
];
...
const KNOWN_LOGO_PATTERNS = [
    ...
    'photo/52678640.cms', 'photo/52678640',
    // Economic Times channel image
    'etimg.com/photo/msid-2865249',
    // Zoom TV
    'zoomtventertainment.com/assets/images/logo',
    // TOI Auto
    ...
    'thehindu.com/theme/',
    // BBC
    'bbc.co.uk/news/special/',
    'bbci.co.uk/ace/standard/',
    // CNN
    'cnn.com/media/sites/',
    // Reuters
    ...
    // ── Additional domain-specific placeholders ──
    'oneindia-lm-logo', 'oneindia-share', 'oneindia_share',
    'staticimg.amarujala.com/assets/img/', 'staticimg.amarujala.com/assets/images/',
];
...
function isLikelyLogo(url) {
    ...
    // Check News24 default template placeholders (e.g. samson-13.jpg)
    if (/\/samson-\d+/.test(lower)) return true;
